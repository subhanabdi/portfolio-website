  ...
  return (
    ...
    >
      ...
      >
        ...
        health-tech, e-commerce, and AI, using <span className="text-AAsecondary"> React.js, Django, AI, Node.js, PHP, Python, Next.js, TypeScript, JavaScript, and other</span> cutting-edge technologies.  <span className="text-AAsecondary"> I have over 5+ years of professional experience,</span>,
