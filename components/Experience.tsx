...
import Upwork from "./Descriptions/Upwork";
import MetallurgicalSystems from "./Descriptions/MetallurgicalSystems";
import JVB  from "./Descriptions/JVB";
import Webilistic from "./Descriptions/Webilistic";
...
export default function Experience() {
  ...
  const GetDescription = () => {
    switch (DescriptionJob) {
      ...
      case "Upwork":
        return <Upwork />;
      case "MetallurgicalSystems":
        return <MetallurgicalSystems />;
      case "JVB":
        return <JVB/>;
      case "Webilistic":
        return <Webilistic />;
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        ...
        <CompanyButton
          ...
          <CompanyButton
            ...
            CompanyName="Metallurgical Systems"
            BarPosition={76}
            BarAvobePosition={257}
            DescriptionJob="MetallurgicalSystems"
          ...
          <CompanyButton
            ...
            CompanyName="Logonado-Tech"
            BarPosition={252}
            BarAvobePosition={769}
            DescriptionJob="Logonado"
...
<CompanyButton
            ...
            CompanyName="Webilistic"
            BarPosition={208}
            BarAvobePosition={641}
            DescriptionJob="Webilistic"
